...
<body>
  ...
  <div class="form-group row">
    <label for="pratikum" class="col-4 col-form-label">Nilai Pratikum</label> 
    <div class="col-8">
      <input id="pratikum" name="pratikum" placeholder="Masukan nilai pratikum" type="text" class="form-control" required="required">
    </div>
  </div> 
  <div class="form-group row">
